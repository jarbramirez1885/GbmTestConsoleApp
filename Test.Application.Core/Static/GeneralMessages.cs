...
namespace Test.Application.Core.Static
{
    public class GeneralMessages
    {
        ...
        public readonly static string BYE = "Are you sure you would like to exit the program?";
        public readonly static string CONFIRM = "Press the Enter key on the keyboard to confirm!";
